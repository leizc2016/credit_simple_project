...
<div class="query-content" role="tabpanel">
              ...
              <div class="tab-content">
                ...
                <!-- 
                 ...
                 -->
                  ...
                  <form class="form-inline search-bar" id="full_form_id" action='${ctx}/corporateLending/fullSearch' >
                    <div class="form-group offset-r30">
                      <label for="">工商注册号:</label>
                      <input type="text" placeholder="" name="search_idCardNum" id="search_idCardNum" class="form-control required input-sm input-xs isIdCardNo2" value='${param.search_idCardNum}'  >
                    </div>
                  ...
                  <div class="row">
                    <div class="col-xs-4">
                      ...
                      <span>公司名称：<span>${personBasicInfo.fullName}</span></span>
                    </div>
                    <div class="col-xs-5">
                      <span class="icon icon-card"></span>
                      <span>工商注册号：<span>${personBasicInfo.idCardNumString}</span></span>
                    </div>
                    <div class="col-xs-3">
      ...
      <script type="text/javascript">
          ...
          $(document).ready(function() {
           ...
           /* 	$.validator.addMethod("isIdCardNo2", function (value, element) {
         	    	
         	        return this.optional(element);
         	    }, "<font color='#E47068'></font>"); */
