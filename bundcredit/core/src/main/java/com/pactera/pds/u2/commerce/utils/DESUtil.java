 ...
 * @packge com.wlyd.wms.controller.api.ApiController
 * @date   2014年5月16日  下午6:06:59
 * @author luogang
 * @comment
 * @update
 */
public class DESUtil {  
    ...
    /** 字符串默认键值 */  
    private static String strDefaultKey = "123123";  
    /** 加密工具 */  
    ...
    public static String encrypt(String strIn) throws Exception { 
    	byte[] by=encrypt(strIn.getBytes("UTF-8"));
